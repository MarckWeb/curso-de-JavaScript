...
import { nombreCliente1 } from './cliente.js';

console.log(nombreCliente1); // También nos va a marcar un error por lo tanto agregamos type="module"
...
let cliente1 = mostrarInformacion(nombreCliente, ahorro);
